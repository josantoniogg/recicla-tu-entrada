...
$_olis;
        $_olis="select * from materiales";
		
			  $query = mysql_query($_olis);
    
?>

 <script type="text/javascript" language="javascript" src="../js/jslistadoproductos.js"></script>
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="display" id="tabla_lista_productos">
                ...
                <tfoot>
                  ...
                  <tbody>
                   ...
                   {
                               echo '<tr>';
                               echo '<td >'.mb_convert_encoding($reg['idmaterial'], "UTF-8").'</td>';
