...
if(isset($_SESSION["txtNombre"])){ 
     ...
     echo "<h7>Bienvenido/a: ".$_SESSION["txtNombre"] ."</h7>";
...
<input type="radio" value="Boleto de Transporte" name="respuesta"><img src="img/bus26.png" width="50px" height="50px"><b> Boleto Transporte</b><br> 
<input type="radio" value="Producto del Comedor" name="respuesta"><img src="img/coffee10.png" width="50px" height="50px"><b> Producto Comedor</b><br> 
<input type="radio" value="Boleto para el cine" name="respuesta"><img src="img/ticket6.png" width="50px" height="50px"><b> Boleto Cine</b><br><br>
<input type="submit" value="Canjear" name="bu" class="myButton">
...
switch ($action)
{
    case 'index':
        ...
        $view->contentTemplate="vwListar.php"; // seteo el template que se va a mostrar
        break;
